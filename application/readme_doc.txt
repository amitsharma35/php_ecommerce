...
Media panel using CodeIgniter 3.1 with Mysql and  Bootstrap.
...
<ul>
  ...
  <li>Login with Admin   for. e.g http://localhost/php_ecommerce/account/login
   admin login details : Username : amitangrish@gmail.com ,password:admin#321 </li>
...
// import mysql queries into database.
...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 17, 2017 at 01:02 PM
